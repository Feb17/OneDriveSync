    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack {
                ...
                .help(syncManager.availableRemotes.isEmpty ? "Add a OneDrive account first" : "Add folder")
            }
            ...
            if syncManager.folders.isEmpty {
                if syncManager.availableRemotes.isEmpty {
                    ...
                    VStack(spacing: 20) {
                        ...
                        Text("Sign in with your Microsoft account to start syncing folders.")
                            .font(.body)
                        ...
                        Button {
                            ...
                            Label("Connect OneDrive", systemImage: "link")
                                .font(.headline)
                    ...
                    ContentUnavailableView {
                        ...
                        Text("Add a folder to start syncing to OneDrive")
                    } actions: {
                        Button("Add Folder") {
                            showingAddSheet = true
                        }
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Form {
                ...
                Section {
                    Picker("OneDrive Account", selection: $selectedRemote) {
    ...
    private var namingView: some View {
        VStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("This helps you identify which OneDrive account this is.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
...
struct GeneralSettingsView: View {
    ...
    var body: some View {
        ...
        .alert("Reset All Settings?", isPresented: $showingResetConfirmation) {
            ...
            Text("This will remove all sync folders and OneDrive account connections from the app. This cannot be undone.")
        }
    }
